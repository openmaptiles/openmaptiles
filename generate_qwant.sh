...
for tiles in 'base' 'poi' 'lite'; do
    ...
    generate-tm2source $tileset  --host="localhost" --port=5432 --database="osm" --user="osm" --password="osm" > generated_${tiles}_tm2source.yml
    $KOSMETIK export generated_${tiles}_tm2source.yml > generated_source_$tiles.xml
done