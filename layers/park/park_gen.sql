UPDATE osm_park_polygon_geometry
   SET geom_z13 = ST_Simplify(geometry, ZRes(13))
 WHERE area>power(ZRes(13),2);

UPDATE osm_park_polygon_geometry
   SET geom_z12 = ST_Simplify(geom_z13, ZRes(12))
 WHERE geom_z13 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z11 = ST_Simplify(geom_z12, ZRes(11))
 WHERE geom_z12 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z10 = ST_Simplify(geom_z11, ZRes(10))
 WHERE geom_z11 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z9 = ST_Simplify(geom_z10, ZRes(9))
 WHERE geom_z10 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z8 = ST_Simplify(geom_z9, ZRes(8))
 WHERE geom_z9 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z7 = ST_Simplify(geom_z8, ZRes(7))
 WHERE geom_z8 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z6 = ST_Simplify(geom_z7, ZRes(6))
 WHERE geom_z7 IS NOT NULL;

UPDATE osm_park_polygon_geometry
   SET geom_z5 = ST_Simplify(geom_z6, ZRes(5))
