...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, name text, name_en text, tags hstore, rank int) AS $$
    ...
    SELECT osm_id, geometry,
        ...
        SELECT osm_id, geometry, name, name_en, tags, leisure, boundary, protection_title
    ...
    SELECT osm_id, geometry_point AS geometry,
        ...
        FROM (
        -- etldoc: osm_park_polygon_gen8 -> layer_park:z6
        SELECT osm_id, geometry_point, name, name_en, tags, leisure, boundary, protection_title, area
        FROM osm_park_polygon_gen8
