...
SELECT CASE
           ...
           WHEN water IN ('river', 'canal', 'ditch', 'drain') THEN 'river'
           %%FIELD_MAPPING: class %%
           ELSE 'lake'
           END;
...
(
    ...
    NULL::boolean AS is_bridge,
    NULL::boolean AS is_tunnel
FROM osm_ocean_polygon_gen_z0
UNION ALL
--etldoc:  osm_water_polygon_gen_z0 -> water_z0
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
...
UNION ALL
--etldoc:  osm_water_polygon_gen_z1 -> water_z1
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
       water_class(waterway, water, leisure) AS class,
       is_intermittent,
...
UNION ALL
--etldoc:  osm_water_polygon_gen_z2 -> water_z2
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
       water_class(waterway, water, leisure) AS class,
       is_intermittent,
...
UNION ALL
--etldoc:  osm_water_polygon_gen_z3 -> water_z3
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
       water_class(waterway, water, leisure) AS class,
       is_intermittent,
...
UNION ALL
--etldoc:  osm_water_polygon_gen_z4 -> water_z4
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
       water_class(waterway, water, leisure) AS class,
       is_intermittent,
...
UNION ALL
--etldoc:  osm_water_polygon_gen_z5 -> water_z5
SELECT osm_id AS id,
       (ST_Dump(geometry)).geom AS geometry,
       water_class(waterway, water, leisure) AS class,
       is_intermittent,
