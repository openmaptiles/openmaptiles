...
DROP MATERIALIZED VIEW IF EXISTS water_point.osm_water_point CASCADE;

CREATE MATERIALIZED VIEW water_point.osm_water_point AS (
    SELECT
...
CREATE INDEX IF NOT EXISTS osm_water_point_geometry_idx ON water_point.osm_water_point USING gist (geometry);
