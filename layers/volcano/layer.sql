...
-- etldoc: layer_volcano[shape=record fillcolor=red,
-- etldoc:     style="rounded,filled", label="layer_volcano | <z7_> z7+" ] ;

CREATE OR REPLACE FUNCTION layer_volcano(bbox geometry, zoom_level integer, pixel_width numeric)
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text, name_de text, tags hstore, ele int, ele_ft int, "rank" int) AS $$
   -- etldoc: osm_volcano_point -> layer_volcano:z7_
